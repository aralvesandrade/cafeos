    ...
    return (
      <Dialog open={open} onClose={handleClose} title="">
        <div className="text-center py-6">
          <CheckCircle className="h-12 w-12 text-terreiro mx-auto mb-4" />
    ...
    return (
      <Dialog open={open} onClose={handleClose} title="Criar Conta">
        <form onSubmit={handleSubmit} className="space-y-4">
          {plan && (
            <div className="bg-ink/5 rounded-lg px-4 py-3 text-sm">
              <span className="text-ink/60">Plano selecionado: </span>
          ...
          <div>
            ...
            <input
              className="w-full rounded-lg border border-ink/15 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-terreiro/40"
              value={form.name}
      ...
      {step === 'channel' ? (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center gap-4 p-4 rounded-lg border border-ink/10 hover:border-terreiro/50 hover:bg-ink/5 transition-colors text-left"
          >
            ...
            <div>
              ...
              <p className="text-xs text-ink/60">Atendimento rápido via mensagem</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-ink/60">Respondemos em até 24 horas</p>
            </div>
          </button>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-4">
          <button
            ...
            className="flex items-center gap-1 text-sm text-ink/60 hover:text-terreiro transition-colors mb-2"
          >
          ...
          <div>
            ...
            <textarea
              className="w-full rounded-lg border border-ink/15 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-terreiro/40 min-h-[80px]"
              value={form.message}
