          ...
          <>
            {activeTab === 'geral' && (
              <div className="grid grid-cols-2 gap-4">
                ...
                <Field label="Área Total da Propriedade (ha)" required>
            ...
            {activeTab === 'producao' && (
              <div className="grid grid-cols-3 gap-4">
                <Field label="Área Plantada (ha)">
                  <Input type="number" step="0.01" value={form.planted_area} onChange={(e) => set('planted_area', e.target.value)} />
                </Field>
                    ...
                    <div key={index} className="rounded-lg border border-border p-4 space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="grid grid-cols-2 gap-4 flex-1">
                          ...
                          <Field label="Papel nesta fazenda" required>
